...
/**
 * This file was generated via php core/scripts/generate-proxy-class.php 'Drupal\courier\ParamConverter\CourierChannelConverter' "modules/courier/src".
 */
...
namespace Drupal\courier\ProxyClass\ParamConverter {
  ...
  class CourierChannelConverter implements \Drupal\Core\ParamConverter\ParamConverterInterface {
     ...
     *
     * @var \Drupal\courier\ParamConverter\CourierChannelConverter
     */
    protected $service;
